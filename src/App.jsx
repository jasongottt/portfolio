...
export default function App() {
  ...
  const projects = [
    ...
    },
    {
      ...
      year: "PRESENT",
      details:
        "I was part of a team of 10 developers and 1 designer, with the goal of communicating with the nonprofit to build a product that would be useful to them. We ended up building a web app that serves as a chore tracking application, event scheduler / tracker, as well as a user manager. I was involved in both frontend and backend development, working on implementing features such as user authentication, database schema design, and various UI components. \n\nWe utilized MongoDB for the database design, as well as the Microsoft Calendar API for the calendar integration. The frontend was done primarily in React. This project was a great experience in terms of working with a team, communicating with a client, and building a full-stack application from start to finish. Due to the nature of this project, a public repository / link is not available.",
      repoUrl: "",
      screenshots: [
    ...
    },
    {
      ...
      repoUrl: "https://github.com/jasongottt",
      screenshots: [
